//
//  PersonalWeightViewController.m
//  WeightCare
//
...
@interface PersonalWeightViewController (){
    RulerView *rulerView;
}

@end

@implementation PersonalWeightViewController
...
-(void)Click{
    [self.navigationController popViewControllerAnimated:YES];
    [[LocalDBManager sharedManager]setUserStartWeight:[NSString stringWithFormat:@"%.1f",[rulerView getResult]] userId:[NSUserDefaults valueWithKey:@"userId"]];
