    ...
    for (int i = 0; i < self.currentCards.count; i++) {
        ...
        switch (i) {
            ...
            case 2:
            {
                ...
                cardView.frame = frame;
                cardView.transform = CGAffineTransformScale(CGAffineTransformIdentity, kThirdCardScale, kThirdCardScale);
...
//                }
            ...
            case 3:
            {
                frame.origin.y = frame.origin.y - kCardEdage * 3;
                cardView.frame = frame;
                cardView.transform = CGAffineTransformScale(CGAffineTransformIdentity, kLastCardScale, kLastCardScale);
                if (CGRectIsEmpty(self.lastCardFrame)) {
                    self.lastCardFrame = frame;
                }
            }
